...
namespace Test_HMC_Clover {
  ...
  int RHMC_Nf2p1_eo(void)
  {
    ...
    //-- N_f=2 part
    unique_ptr<Fopr> fopr_Nf2(Fopr::New(str_fopr_Nf2_type, params_fopr_Nf2));

    unique_ptr<Force> force_fopr_Nf2(new Force_F_Clover_Nf2(params_fopr_Nf2));

    unique_ptr<Fopr>  fopr_smear_Nf2(Fopr::New("Smeared", fopr_Nf2.get(), dr_smear.get()));
    ...
    unique_ptr<Fopr> fopr_Nf2_eo(Fopr::New(str_fopr_Nf2_type + "_eo", params_fopr_Nf2));

    unique_ptr<Fopr> fopr_smear_Nf2_eo(Fopr::New("Smeared_eo", fopr_Nf2_eo.get(), dr_smear.get()));

    unique_ptr<Solver> solver_Nf2_eo_MD(Solver::New(str_solver_Nf2_MD_type, fopr_smear_Nf2_eo.get(), params_solver_Nf2_MD));
    unique_ptr<Fprop>  fprop_Nf2_eo_MD(new Fprop_Standard_eo(solver_Nf2_eo_MD.get()));

    unique_ptr<Solver> solver_Nf2_eo_H(Solver::New(str_solver_Nf2_H_type, fopr_smear_Nf2_eo.get(), params_solver_Nf2_H));
    unique_ptr<Fprop>  fprop_Nf2_eo_H(new Fprop_Standard_eo(solver_Nf2_eo_H.get()));

    //-- N_f=2 part (preconditioner)
    unique_ptr<Fopr> fopr_Nf2_prec(Fopr::New(str_fopr_Nf2_prec_type, params_fopr_Nf2_prec));

    unique_ptr<Force> force_fopr_Nf2_prec(new Force_F_Clover_Nf2(params_fopr_Nf2_prec));

    unique_ptr<Fopr>  fopr_smear_Nf2_prec(Fopr::New("Smeared", fopr_Nf2_prec.get(), dr_smear.get()));
    ...
    unique_ptr<Fopr> fopr_Nf2_eo_prec(Fopr::New(str_fopr_Nf2_prec_type + "_eo", params_fopr_Nf2_prec));

    unique_ptr<Fopr> fopr_smear_Nf2_eo_prec(Fopr::New("Smeared_eo", fopr_Nf2_eo_prec.get(), dr_smear.get()));

    unique_ptr<Solver> solver_Nf2_eo_MD_prec(Solver::New(str_solver_Nf2_MD_type, fopr_smear_Nf2_eo_prec.get(), params_solver_Nf2_MD));
    unique_ptr<Fprop>  fprop_Nf2_eo_MD_prec(new Fprop_Standard_eo(solver_Nf2_eo_MD_prec.get()));

    unique_ptr<Solver> solver_Nf2_eo_H_prec(Solver::New(str_solver_Nf2_H_type, fopr_smear_Nf2_eo_prec.get(), params_solver_Nf2_H));
    unique_ptr<Fprop>  fprop_Nf2_eo_H_prec(new Fprop_Standard_eo(solver_Nf2_eo_H_prec.get()));


    unique_ptr<Action> action_F_Nf2_prec(new Action_F_Standard_eo(fopr_smear_Nf2_prec.get(), force_fopr_smear_Nf2_prec.get(), fprop_Nf2_eo_MD_prec.get(), fprop_Nf2_eo_H_prec.get()));

    unique_ptr<Action> action_F_Nf2_d(new Action_F_Ratio_eo(fopr_smear_Nf2_prec.get(), force_fopr_smear_Nf2_prec.get(), fopr_smear_Nf2.get(), force_fopr_smear_Nf2.get(), fprop_Nf2_eo_H_prec.get(), fprop_Nf2_eo_MD.get(), fprop_Nf2_eo_H.get()));

    //-- N_f=1 part
    unique_ptr<Fopr> fopr_Nf1(Fopr::New(str_fopr_Nf1_type, params_fopr_Nf1));

    //- NB. create Force_F_Nf2, then apply rational approximation
    unique_ptr<Force> force_fopr_Nf1(new Force_F_Clover_Nf2(params_fopr_Nf1));

    //- NB. Langevin needs params_rational_H
    unique_ptr<Fopr> fopr_r1(Fopr::New("Rational", fopr_Nf1.get(), params_rational_H));
    unique_ptr<Fopr> fopr_smear_Nf1_langev(Fopr::New("Smeared", fopr_r1.get(), dr_smear.get()));

    //- NB. Hamiltonian needs params_rational_MD
    unique_ptr<Fopr> fopr_r2(Fopr::New("Rational", fopr_Nf1.get(), params_rational_MD));
    unique_ptr<Fopr> fopr_smear_Nf1_H(Fopr::New("Smeared", fopr_r2.get(), dr_smear.get()));
