...
namespace Test_HMC_Clover_Isochemical {
  ...
  int update_Nf2(void)
  {
    ...
    unique_ptr<Force> force_fopr(new Force_F_Clover_Nf2_Isochemical(params_fopr));
    ...
    unique_ptr<QuarkNumberSusceptibility_Wilson> quark_suscept(new QuarkNumberSusceptibility_Wilson(fopr_smear.get(), fprop_H.get(), nv.get(), params_test));
