...
#include "lib_alt/Measurements/Fermion/fprop_alt_Standard_eo_Mixedprec-tmpl.h"

template<>
const std::string Fprop_alt_Standard_eo_Mixedprec<AField<double, QXS>, AField<float, QXS> >::class_name
  = "Fprop_alt_Standard_eo_Mixedprec<AField<double,QXS>, AField<float,QXS> >";

// class instanciation
template class Fprop_alt_Standard_eo_Mixedprec<AField<double, QXS>, AField<float, QXS> >;
