...
/*!
    ...
    Implementation is modernized suitably to ver.2.0.
                                    [21 Feb 2022 H.Matsufuru]
 */
...
namespace Org {
  class Fopr_CloverTerm : public Fopr
  {
   ...
   private:
    ...
    Field_G m_Cup, m_Cdn, m_Umu, m_u1, m_u2;  //!< working field
    Field_F m_v1, m_v2, m_v3;                 //!< working field
